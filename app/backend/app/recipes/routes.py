...
router.add_api_route('/api/recipes/{recipe_id}/knitting-tools', services.get_recipe_knitting_tools, methods=['GET'])
router.add_api_route('/api/recipes/{recipe_id}/knitting-tools', services.save_recipe_knitting_tools, methods=['PUT'])
