...
router.add_api_route('/api/admin/recipes', services.get_recipe_settings, methods=['GET'])
router.add_api_route('/api/admin/recipes', services.save_recipe_settings, methods=['PUT'])
router.add_api_route('/api/admin/recipes/migrate-to-pdf', services.start_pdf_migration, methods=['POST'])
router.add_api_route('/api/admin/recipes/migrate-to-pdf/status', services.get_pdf_migration_status, methods=['GET'])
router.add_api_route('/api/admin/recipes/migrate-to-pdf/cancel', services.cancel_pdf_migration, methods=['POST'])
