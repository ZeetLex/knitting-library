"""Shared backend services for Knitting Recipe Library.

This module intentionally preserves the pre-refactor endpoint implementations while
routes are registered from focused router modules. Keep behavior-compatible changes
here until a smaller service/repository extraction is safe.
"""
